...
export interface Foreach extends WithWith, WithReturn, WithRemove, WithSet, WithDelete, WithMerge {}
 ...
 * @group Clauses
 */
@mixin(WithWith, WithReturn, WithRemove, WithSet, WithDelete, WithMerge)
