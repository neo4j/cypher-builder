...
export interface Foreach extends WithWith, WithReturn, WithRemove, WithSet, WithDelete, WithCreate {}
 ...
 * @group Clauses
 */
@mixin(WithWith, WithReturn, WithRemove, WithSet, WithDelete, WithCreate)
