...
export interface With extends WithOrder, WithReturn, WithWhere, WithDelete, WithUnwind, WithMatch {}

/**
 * @see [Cypher Documentation](https://neo4j.com/docs/cypher-manual/current/clauses/with/)
 * @group Clauses
 */
@mixin(WithOrder, WithReturn, WithWhere, WithDelete, WithUnwind, WithMatch)
